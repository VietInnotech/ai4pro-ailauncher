...
if (-not $OutputDir) { $OutputDir = Join-Path $RepoRoot 'src-tauri/binaries' }
...
Write-Output 'Manually build llama.cpp for the target platform, then place the resulting llama-server binary into src-tauri/binaries/.'
